...
### Daily view
!['booked-slots-available'](https://github.com/AndrewGalatsan/scheduler-3/blob/master/docs/booked-slots-available.png?raw=true)
_By selecting a weekday on the left panel, a user can see booked appointments and available slots for each day._


### New appointment booking
!['book-new-apt'](https://github.com/AndrewGalatsan/scheduler-3/blob/master/docs/book-new-apt.png?raw=true)
...
!['cancel-apt-confirm-delete'](https://github.com/AndrewGalatsan/scheduler-3/blob/master/docs/cancel-apt-confirm-delete.png?raw=true)
